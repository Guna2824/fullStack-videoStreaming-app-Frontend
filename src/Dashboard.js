        ...
        <div className="mx-[10%] flex flex-wrap justify-start gap-6">
          {searchUser !== ""
                    ...
                    <div className="w-[100%] h-[50%]">
                      ...
                      <div className="flex">
                        {!show &&
                          ...
                          share.map((data) => {
                            return (
                              <div className="relative top-[-110px] mx-[23px] ">
                                {data.name}
                              </div>
                            );
                          })}
            ...
            : data &&
              data.map((item, index) => {
                return (
                  <div className="bg-[rgba(255,255,255,0.8)] p-2 w-[300px] h-[300px] m-2 flex flex-col gap-1 items-center rounded-lg shadow-lg">
